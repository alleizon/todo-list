...
const DOM = (() => {
  ...
  const createProjectForm = () => {
    ...
    closeBtn.addEventListener("click", _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].closeProjectForm);
  ...
  const createTodoForm = () => {
    ...
    const formDiv = _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].createTodoForm();
  ...
  const renderInbox = () => {
    removeContent();
    _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].closeTodoForm();
    const content = document.querySelector(".content");
    const inbox = _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.getInbox();
    _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.updateCurrentProject(inbox);
    inbox.todos.forEach((element, index) => {
      const div = _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].createDOMTodo(element, index);
  ...
  const renderToday = () => {
    removeContent();
    _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].closeTodoForm();
    _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.updateCurrentProject("today");
    const todos = _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.getTodayTodos();
    const filtered = todos.filter((element) => element.dueDate);
    if (filtered.length) {
      filtered.forEach((todo, index) => {
        const div = _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].createDOMTodo(
          todo,
          index,
          _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectFromUnfilteredArray(todo, todos)
        );
  ...
  const renderWeek = () => {
    removeContent();
    _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].closeTodoForm();
    _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.updateCurrentProject("week");
    const todos = _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.getWeekTodos();
    const filtered = todos.filter((todo) => todo.dueDate);
    if (filtered.length) {
      filtered.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(a.dueDate, b.dueDate));
      filtered.forEach((todo, index) => {
        const div = _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].createDOMTodo(
          todo,
          index,
  ...
  const renderProject = (e) => {
    ...
    const proj = _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.getProjectByName(projectName);
    _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.updateCurrentProject(proj);
  ...
  const renderProjectsList = () => {
    const createWrapper = (li) => {
      ...
      btn.addEventListener("click", _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].removeProject);
      div.append(li, btn);
      return div;
    };
    const list = _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.getProjectListNames().slice(1);
...
const ELS = (() => {
  const init = () => {
    ...
    const storageList = _storage__WEBPACK_IMPORTED_MODULE_2__["default"].getStorageList();
    if (storageList) {
      ...
      _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.updateStoredList(storageList);
      if (storageList.length > 1) {
        DOM.renderProjectsList();
      }
    } else _projects__WEBPACK_IMPORTED_MODULE_0__.projectList.initList();
  };
  ...
  const newProj = () => {
    _domHelpers__WEBPACK_IMPORTED_MODULE_1__["default"].addProject();
    const addedProj =
...
const Helpers = (() => {
  ...
  const getProjectFromUnfilteredArray = (todo, unfiltered) => {
    ...
    for (let i = index; i >= 0; i -= 1) {
      if (unfiltered[i] instanceof _projects__WEBPACK_IMPORTED_MODULE_1__.Project) return unfiltered[i].name;
    }
  };
  ...
  const completeTodo = (e) => {
    ...
    const curProject = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getCurrentProject();
    if (curProject.name === "Today" || curProject.name === "This week") {
      const proj = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProjectByName(todoDiv.dataset.project);
      const time = todoDiv.dataset.ts;
      const date = new Date(+time);
      proj.findTodo(date).markCompleted();
    } else curProject.todos[index].markCompleted();
    todoDiv.classList.toggle("completed");
    _storage__WEBPACK_IMPORTED_MODULE_2__["default"].storeProjects();
  };
  ...
  const removeDOMTodo = (e) => {
    ...
    const curProject = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getCurrentProject();
    if (curProject.name === "Today" || curProject.name === "This week") {
      const proj = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProjectByName(parent.dataset.project);
  ...
  const createDOMTodo = (todo, index, projName) => {
    ...
    dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todo.dueDate, "dd/MM/yyyy");
  ...
  const removeProject = (e) => {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.removeProject(_projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProjectByName(projectName));
    parentDiv.remove();
    _storage__WEBPACK_IMPORTED_MODULE_2__["default"].storeProjects();
  };
  ...
  const addProject = () => {
    ...
    const newProj = new _projects__WEBPACK_IMPORTED_MODULE_1__.Project(projInput.value);
    if (_projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProject(newProj)) {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.addProject(newProj);
    _storage__WEBPACK_IMPORTED_MODULE_2__["default"].storeProjects(newProj);
  ...
  const createTodo = (info) => {
    ...
    const todo = new _todo__WEBPACK_IMPORTED_MODULE_0__["default"](title, desc, date, priority);
    const projectObj = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProjectByName(project);
    projectObj.addTodo(todo);
    _storage__WEBPACK_IMPORTED_MODULE_2__["default"].storeProjects();
    if (_projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getCurrentProject().name === project)
      appendToCurrentPage(todo);
    if (
      _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getCurrentProject().name === "Today" &&
      checkTodayTodo(date)
    )
      appendToCurrentPage(todo, project);
    if (
      _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getCurrentProject().name === "This week" &&
      checkWeekTodo(date)
    ) {
      const weekTodos = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getWeekTodos();
      const filtered = weekTodos.filter((element) => element.dueDate);
      filtered.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(a.dueDate, b.dueDate));
  ...
  const getFormInfo = () => {
    ...
    const info = [];
    for (let i = 0; i < 4; i += 1) {
      if (i === 1) info.push(children.item(i).lastElementChild.value);
      else info.push(children.item(i).value);
    }
    ...
    info[2] = info[2] ? formDate : new Date();
  ...
  const createTodoForm = () => {
    ...
    const createDate = () => {
      ...
      const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "yyyy-MM-dd");
    ...
    const createProjectSelect = () => {
      ...
      label.setAttribute("for", "form-todo-project");
      const select = document.createElement("select");
      select.id = "form-todo-project";
      select.name = "form-todo-project";
      const projects = _projects__WEBPACK_IMPORTED_MODULE_1__.projectList.getProjectListNames();
    ...
    const createPriority = () => {
      const selectFormPriority = (e) => {
        ...
        if (curPriority === selected) {
          ...
          btn.classList.remove(`p${curPriority}`);
          curPriority = 0;
          return;
        }
        ...
        if (curPriority)
          document
            ...
            .classList.remove("selected", `p${curPriority}`);
      ...
      btnWrapper.classList.add("priority-buttons");
      btnWrapper.append(low, medium, high);
      div.append(label, btnWrapper);
      formDiv.appendChild(div);
...
const Storage = (() => {
  const restoreTodoObject = (todo) => {
    ...
    return new _todo__WEBPACK_IMPORTED_MODULE_1__["default"](values[0], values[1], values[2], values[3], values[4]);
  };

  const restoreProjectObject = (project) => {
    const newProj = new _projects__WEBPACK_IMPORTED_MODULE_0__.Project();
  ...
  const storeProjects = () => {
    localStorage.setItem("list", JSON.stringify(_projects__WEBPACK_IMPORTED_MODULE_0__.projectList.getList()));
  };
